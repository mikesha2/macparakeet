...
struct TranscribeCommand: AsyncParsableCommand, CLITelemetryMetadataProviding {
    ...
    @Option(name: .long, help: "Parakeet build: app-default, v3 (English + supported European languages), v2 (English word timestamps), unified (readable English, no word timestamps), omi-med-v1 (English medical). app-default follows the saved preference; ignored for Nemotron, Cohere, and Whisper.")
